...
namespace MappingExtensions.Harmony_Patches
{
    ...
    class BeatmapDataClearNotesBeforeStartTimeTransformCreateTransformedData
    {
        static bool Prefix(BeatmapData beatmapData, float startSongTime, ref BeatmapData __result)
        {
            ...
            do
            {
                ...
                if (flag)
                {
                    ...
                    if (ShouldUseBeatmapObject(beatmapObjectData2, startSongTime))
                    {
        ...
        private static bool ShouldUseBeatmapObject(BeatmapObjectData beatmapObjectData, float startSongTime)
        {
            return beatmapObjectData.time >= startSongTime;
        }
